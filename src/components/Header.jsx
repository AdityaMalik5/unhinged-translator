  ...
  return (
    <header className="relative z-10 text-center pt-8 pb-4 px-4">
      <div className="relative inline-block max-w-full">
        ...
        />
        <h1
          className="text-ink tracking-tight mb-2 leading-[0.95] drop-shadow-[0_0_30px_rgba(245,198,184,0.9)]"
          style={{
      ...
      <div className="mt-3 inline-flex items-center gap-1.5 bg-cream-white/80 backdrop-blur-sm rounded-full px-4 py-1.5 text-sm font-bold text-ink-light border border-blush-dark/30">
